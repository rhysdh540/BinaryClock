...
public class PrefsSaver {
     ...
     */
    private static final File PREFS_FILE_PATH = new File(System.getProperty("user.home") + File.separator + ".rdh" + File.separator + "binaryclock" + File.separator + "prefs_legacy.txt");
